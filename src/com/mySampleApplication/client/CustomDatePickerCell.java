...
public class CustomDatePickerCell  extends AbstractEditableCell<Date, Date> {
     ...
     */
    public CustomDatePickerCell(DateTimeFormat format) {
     ...
     */
    public CustomDatePickerCell(SafeHtmlRenderer<String> renderer) {
     ...
     * @param renderer a {@link SafeHtmlRenderer SafeHtmlRenderer<String>} instance
     */
    public CustomDatePickerCell(DateTimeFormat format, SafeHtmlRenderer<String> renderer) {
        super(CLICK, KEYDOWN);
        if (format == null) {
